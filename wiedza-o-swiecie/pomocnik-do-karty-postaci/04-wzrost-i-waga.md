...
| Rasa      | Dorosłość | Barbarzyńca, Łotr, Czarownik | Bard, Wojownik, Paladyn, Łowca, Żeglarz, Rycerz | Kapłan, Druid, Mnich, Czarodziej, Szaman |
|-----------|-----------|------------------------------|-------------------------------------------------|------------------------------------------|
...
Aby uzyskać swóją losową wagę: wynik kostki wzrostu pomnóż przez wynik kostki wagi i dodaj do bazowej wagi. **Dla przykładu**:\
1. Rrzucasz na **modyfikator wzrostu** dla twojego krasnoluda ♂, wypada (2k4: 2+4 =) **6**, co daje końcowy wzrost **4'3"** (do bazowego 3'9" dodajesz wyrzucone 6").
2. Następnie rzucasz na **modyfikator wagi**, wypada (2k6: 3+5 =) **8**.
3. Wynik kostki wzrostu pomnóż przez wynik kostki wagi: 6 pomnożone przez 8 daje **48**. 48 dodajesz do bazowej wagi (130 lb.), razem wychodzi **178 lb**.
4. Po przekonwertowaniu na system metryczny, otrzymujemy krasnoluda o wzroście 130 cm i wadze 81 kg. Przekonwertowanie na system metryczny najlepiej zrobić już po wybraniu wysokości/wagi w systemie imperialnym.

:::

## Rasy prestiżowe

Dla ras prestiżowych używasz odpowiednio tabel:
- **Aasimar** : człowieka
- **Dialbestwo** : człowieka
- **Drow** : elfa
- **Genasi** : człowieka
