...
Zmiana wyglądu broni oraz tarcz jest możliwa przy użyciu kowadła, które możesz odnaleźć w pracowniach kowalskich różnych miast. 

Aby móc użyć kowadła musisz dzierżyć Lekki Młot. Broń tę kupisz w każdej kuźni, gdzie znajdują się i kowadła. Pamiętaj, że aby jej użyć, twoja postać musi posiadać atut "Używanie broni (bronie bojowe)".
...
W tej chwili nie ma możliwości zmiany wyglądu tych broni.
